...
\begin{minipage}[t]{0.50\textwidth}
  ...
  \href{mailto:ywang812@foxmail.com}{ywang812@foxmail.com}
\end{minipage}
...
% ── Profile ──
{\small\color{midgray}
港大机械工程 MPhil，三年半腱驱动机器人与手术机器人研发经验。具备从机械设计（SolidWorks）、嵌入式控制（PCB 设计与贴片）到软件集成（ROS~/~C++~/~Python）的完整项目交付能力。论文发表于 \textit{Nature Communications}、\textit{IEEE RA-L}、\textit{IEEE ROBIO}，具备将前沿研究转化为工程原型（手术器械、自适应抓取系统）的落地经验。
}
...
\vspace{0.15em}
\centering
{\sffamily\bfseries 机器人系统工程师 \,/\, 手术机器人研发工程师 \quad|\quad 深圳 \quad|\quad 2026 年 6 月已毕业，可随时到岗}
\vspace{0.15em}
\textcolor{accent}{\rule{\textwidth}{1.2pt}}
